...
class WC_PB_Display {
	...
	function woo_bundles_frontend_scripts() {
		...
		$params = array(
			...
			'i18n_select_options'           => sprintf( __( '<p class="price"><span class="bundle_error">%s</span></p>', 'woocommerce-product-bundles' ), __( 'Please choose a T-Shirt Style and Size.', 'woocommerce-product-bundles' ) ),
