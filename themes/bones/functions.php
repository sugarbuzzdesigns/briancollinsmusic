...
add_image_size( 'post_155', 155, 9999, false );
...
function bones_register_sidebars() {
  ...
  register_sidebar(array(
    ...
    'name' => __( 'Newsletter Widget', 'bonestheme' ),
    'description' => __( 'Newsletter Signup Widget', 'bonestheme' ),
    'before_widget' => '<div id="mc-newsletter">',
    'after_widget' => '</div>',
    'before_title' => '<h4 class="widgettitle">',
    'after_title' => '</h4>',
  ));
  ...
  register_sidebar(array(
    'id' => 'newsletter-fb-test',
    'name' => __( 'Newsletter FB Widget', 'bonestheme' ),
    'description' => __( 'Newsletter Signup Widget', 'bonestheme' ),
    'before_widget' => '<div id="fb-newsletter">',
    'after_widget' => '</div>',
    'before_title' => '<h4 class="widgettitle">',
    'after_title' => '</h4>',
  ));
